...
class SightingsControllerTest < ActionController::TestCase
  ...
  test "should create sighting" do
    assert_difference('Sighting.count') do
      post :create, sighting: { creatures_list: @sighting.creatures_list, fieldnotes: @sighting.fieldnotes, location: @sighting.location, timestamp: @sighting.timestamp }
    end
  ...
  test "should update sighting" do
    patch :update, id: @sighting, sighting: { creatures_list: @sighting.creatures_list, fieldnotes: @sighting.fieldnotes, location: @sighting.location, timestamp: @sighting.timestamp }
    assert_redirected_to sighting_path(assigns(:sighting))
  end
